...
# TODO: when you want to run this move it in the explainer folder and adjust the imports
"""
import os
...
parser.add_argument("--exp", type=str, default="4_smallpedia", help="Path to the configuration file")
args, _ = parser.parse_known_args()    

exp_name = args.exp  # name of the explanation experiment; will create a folder with this name in files/explanations/
...
num_cpus= 1 # number of cpus to use for parallel processing  #right now it only works with 1 cpu
...
mrr, hits10, hits1, hits100, mrr_per_rel, hit1_per_rel, mrr_per_ts, hit1_per_ts= eval.evaluate(dataset, path_rankings, 0.01, evaluation_mode=dataset_split, eval_type='random', special_evalquads=quadruples)
print('now writing ranks per rel to file')
utils.write_ranksperrel(mrr_per_rel, hit1_per_rel, out_folder, dataset.dataset.name, 'val')
